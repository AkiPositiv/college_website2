document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        "uz": {
            ...
            "social_telegram_link": "https://t.me/Politexnikum2sonli",
            ...
            "faq_a2": "Ha, boshqa shahardan kelgan talabalar uchun Politexnikum yotoqxonasida bo‘sh joylar mavjud bo‘lganda yashash imkoniyati beriladi. Batafsil ma'lumotni qabul komissiyasidan olishingiz mumkin.",
            "faq_q3": "Pullik asosda ta'lim olish imkoniyati bormi?",
            "faq_a3": "Ha, Politexnikumda byudjet va pullik asosda ta'lim olish imkoniyati mavjud. O‘qish narxi va to‘lov shartlarini qabul komissiyasidan bilib oling.",
        ...
        "ru": {
            ...
            "faq_a2": "Да, для иногородних студентов предоставляется возможность проживания в общежитии Политехникума при наличии свободных мест. Подробности можно узнать в приемной комиссии.",
            "faq_q3": "Есть ли возможность получения образования на платной основе?",
            "faq_a3": "Да, в Политехникуме предусмотрено обучение как на бюджетной, так и на платной основе. Стоимость обучения и условия оплаты уточняйте в приемной комиссии.",
